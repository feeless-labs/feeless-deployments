...
Addresses and ABIs can be consumed from the package in JavaScript environments, or manually retrieved from the [GitHub](https://github.com/feeless-labs/feeless-v2-monorepo/tree/master/pkg/deployments) repository.
