...
exports.excludedRoles = exports.roles = exports.delayedRoles = void 0;
...
const ComposableStablePoolV2 = new _src_1.Task('20221122-composable-stable-pool-v2', _src_1.TaskMode.READ_ONLY, 'mainnet');
const WeightedPoolV2 = new _src_1.Task('20220908-weighted-pool-v2', _src_1.TaskMode.READ_ONLY, 'mainnet');
const NoProtocolFeeLbp = new _src_1.Task('20211202-no-protocol-fee-lbp', _src_1.TaskMode.READ_ONLY, 'mainnet');
const ManagedPool = new _src_1.Task('20221021-managed-pool', _src_1.TaskMode.READ_ONLY, 'mainnet');
const AaveRebalancedLinearPool = new _src_1.Task('20220817-aave-rebalanced-linear-pool', _src_1.TaskMode.READ_ONLY, 'mainnet');
const AaveRebalancedLinearPoolV3 = new _src_1.Task('20221207-aave-rebalanced-linear-pool-v3', _src_1.TaskMode.READ_ONLY, 'mainnet');
const PoolRecoveryHelper = new _src_1.Task('20221123-pool-recovery-helper', _src_1.TaskMode.READ_ONLY, 'mainnet');
const ArbitrumRootGaugeFactoryV2 = new _src_1.Task('20220823-arbitrum-root-gauge-factory-v2', _src_1.TaskMode.READ_ONLY, 'mainnet');
const GaugeAdderV3 = new _src_1.Task('20230109-gauge-adder-v3', _src_1.TaskMode.READ_ONLY, 'mainnet');
const GaugeController = new _src_1.Task('20220325-gauge-controller', _src_1.TaskMode.READ_ONLY, 'mainnet');
const GaugeAdderV2ToV3Migrator = new _src_1.Task('20230109-gauge-adder-migration-v2-to-v3', _src_1.TaskMode.READ_ONLY, 'mainnet');
...
const createRoleData = (grantee, target, actionIds) => actionIds.map((actionId) => ({ role: actionId, grantee: grantee.toLowerCase(), target: target.toLowerCase() }));
// Hard-coded roles taken from https://forum.balancer.fi/t/bip-131-pool-factory-permission-granting/4144.
const poolRoles = (0, lodash_1.flatten)([
...
const factoryRoles = (0, lodash_1.flatten)([
...
const liquidityMiningRoles = (0, lodash_1.flatten)([
...
exports.delayedRoles = (0, lodash_1.flatten)([
...
exports.roles = (0, lodash_1.flatten)([...poolRoles, ...factoryRoles, ...liquidityMiningRoles]);
// These are on-chain permissions in the old authorizer that should not be migrated to the new authorizer.
exports.excludedRoles = (0, lodash_1.flatten)([
    createRoleData(BALLERS_MULTISIG_GAUNTLET, EVERYWHERE, [
