...
(0, _src_2.describeForkTest)('AaveLinearPoolFactory V4', 'mainnet', 16592300, function () {
    ...
    before('run task', async () => {
        task = new _src_2.Task('20230206-aave-rebalanced-linear-pool-v4', _src_2.TaskMode.TEST, (0, _src_2.getForkedNetwork)(hardhat_1.default));
    ...
    describe('create and check getters', () => {
        it('deploy a linear pool', async () => {
            const tx = await factory.create('', '', USDT, waUSDT, INITIAL_UPPER_TARGET, SWAP_FEE_PERCENTAGE, owner.address, PROTOCOL_ID);
