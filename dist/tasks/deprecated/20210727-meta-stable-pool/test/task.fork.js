...
(0, _src_1.describeForkTest)('MetaStablePoolFactory', 'mainnet', 14850000, function () {
    let owner, whale;
    ...
    const rateProviders = [constants_1.ZERO_ADDRESS, constants_1.ZERO_ADDRESS];
    ...
    before('run task', async () => {
        task = new _src_1.Task('20210727-meta-stable-pool', _src_1.TaskMode.TEST, (0, _src_1.getForkedNetwork)(hardhat_1.default));
    ...
    it('deploy a meta stable pool', async () => {
        const tx = await factory.create('MSP', 'MSPT', tokens, amplificationParameter, rateProviders, cacheDurations, swapFeePercentage, oracleEnabled, owner.address);
