...
(0, _src_1.describeForkTest)('ComposableStablePool V5', 'mainnet', 17663500, function () {
    let task;
    let factory;
    let owner;
    ...
    before('run task', async () => {
        task = new _src_2.Task('20230711-composable-stable-pool-v5', _src_2.TaskMode.TEST, (0, _src_3.getForkedNetwork)(hardhat_1.default));
