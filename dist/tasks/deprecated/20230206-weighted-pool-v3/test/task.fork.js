...
(0, _src_2.describeForkTest)('WeightedPool V3', 'mainnet', 16577000, function () {
    ...
    before('run task', async () => {
        task = new _src_2.Task('20230206-weighted-pool-v3', _src_2.TaskMode.TEST, (0, _src_2.getForkedNetwork)(hardhat_1.default));
    ...
    async function createPool() {
        const receipt = await (await factory.create(NAME, SYMBOL, tokens, WEIGHTS, [constants_1.ZERO_ADDRESS, constants_1.ZERO_ADDRESS, constants_1.ZERO_ADDRESS], POOL_SWAP_FEE_PERCENTAGE, owner.address)).wait();
    ...
    describe('factory disable', () => {
        it('the factory can be disabled', async () => {
            ...
            await (0, chai_1.expect)(factory
                .connect(owner)
                .create(NAME, SYMBOL, tokens, WEIGHTS, [constants_1.ZERO_ADDRESS, constants_1.ZERO_ADDRESS, constants_1.ZERO_ADDRESS], POOL_SWAP_FEE_PERCENTAGE, owner.address)).to.be.revertedWith('BAL#211');
        });
    });
});
