...
(0, _src_1.describeForkTest)('ComposableStablePool V3', 'mainnet', 16577000, function () {
    let task;
    let factory;
    let owner;
    let whale, auraWhale;
    ...
    before('run task', async () => {
        task = new _src_2.Task('20230206-composable-stable-pool-v3', _src_2.TaskMode.TEST, (0, _src_3.getForkedNetwork)(hardhat_1.default));
    ...
    async function createPool(tokens, rateProvider = constants_1.ZERO_ADDRESS, initialize = true) {
