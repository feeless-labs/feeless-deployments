...
(0, _src_1.describeForkTest)('MerkleRedeem', 'arbitrum', 1731663, function () {
    let lp, other, whale;
    ...
    before('run task', async () => {
        task = new _src_1.Task('20210928-mcb-arbitrum-merkle', _src_1.TaskMode.TEST, (0, _src_1.getForkedNetwork)(hardhat_1.default));
    ...
    before('load signers and transfer ownership', async () => {
        ...
        whale = await (0, _src_1.impersonate)(REWARD_WHALE_ADDRESS);
