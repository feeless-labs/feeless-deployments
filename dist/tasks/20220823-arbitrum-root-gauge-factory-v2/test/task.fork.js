...
(0, _src_1.describeForkTest)('ArbitrumRootGaugeFactoryV2', 'mainnet', 15397200, function () {
    ...
    before('run task', async () => {
        task = new _src_1.Task('20220823-arbitrum-root-gauge-factory-v2', _src_1.TaskMode.TEST, (0, _src_1.getForkedNetwork)(hardhat_1.default));
    ...
    it('grant permissions', async () => {
        ...
        await Promise.all(['addGaugeFactory', 'addArbitrumGauge'].map(async (method) => await authorizer.connect(govMultisig).grantRole(await (0, actions_1.actionId)(gaugeAdder, method), admin.address)));
